# Feature Flow: Analytics & Credit Health
...
```mermaid
flowchart TD
  A[Dashboard] --> B[GET /analytics/repayment]
  A --> C[GET /credit/health]
```

## Step ↔ API Mapping
- Repayment analytics → `GET /analytics/repayment`
- Credit health → `GET /credit/health`
