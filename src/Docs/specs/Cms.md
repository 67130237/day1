...
**OpenAPI 3.1.0 (Service: CmsController)** — generated 2025-08-24

```yaml
openapi: 3.1.0
info: { title: CMS Content Service, version: 1.0.0 }
servers: [ { url: http://localhost:5080/api/v1 } ]
paths:
  /cms/banners: { get: { summary: Home banners, responses: { '200': { description: List } } } }
  /cms/articles: { get: { summary: Articles, responses: { '200': { description: List } } } }
  /cms/articles/{slug}: { get: { summary: Article by slug, responses: { '200': { description: Item }, '404': { description: Not found } } } }
