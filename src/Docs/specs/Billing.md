...
**OpenAPI 3.1.0 (Service: BillingController)** — generated 2025-08-24
...
paths:
  /billing/{loanId}/next-due: { get: { summary: Next due invoice, responses: { '200': { description: Invoice } } } }
  /billing/{loanId}/invoices: { get: { summary: List invoices, responses: { '200': { description: Invoices } } } }
  /billing/invoices/{invoiceId}: { get: { summary: Get invoice, responses: { '200': { description: Invoice }, '404': { description: Not found } } } }
